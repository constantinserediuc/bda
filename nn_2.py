...
def tokenize(a, logger):
    ...
    # logger.warn(a)
    tokens = [float(elem) for elem in a]
    return tokens
...
def nn(text, summ, word_dict):
    ...
    # Encode the input sequence to get the "thought vectors"
        ...
        def decode_sequence(input_seq):
            ...
            result = [reverse_target_char_index[int(e*4000 + 4000)] for e in states_value if int(e*4000 + 4000) in reverse_target_char_index]
            return result
        ...
        # print('\nInput paper words:', translate_to_words(X_train[k:k+1])[1])
        print('\nActual abstract words:', translate_to_words(y_train[k:k+1])[1])
        print('\nPredicted abstract words:', decoded_sentence[:-1])
